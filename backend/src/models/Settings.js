...
const settingsSchema = new mongoose.Schema({
  ...
  custom: {
    ...
    branches:  { type: [String], default: ['Noida Sector 62'] },
    fields:    { type: [String], default: [] },
    // ← NEW: admin-managed custom roles like CONNECTOR, CA, BANKER, INTERN
    roles:     { type: [String], default: ['CONNECTOR', 'CA', 'BANKER', 'INTERN'] }
  },
  permissions: {
    type: Map, of: Map,
    default: () => ({
